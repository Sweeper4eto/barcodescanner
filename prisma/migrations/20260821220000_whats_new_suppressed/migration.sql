...
INSERT INTO "new_WhatsNewItem" ("id", "sourceKey", "titleEn", "titleBg", "href", "active", "sortOrder", "createdAt", "updatedAt")
SELECT "id", "sourceKey", "titleEn", "titleBg", "href", "active", "sortOrder", "createdAt", "updatedAt" FROM "WhatsNewItem";
...
CREATE INDEX "WhatsNewItem_suppressed_idx" ON "WhatsNewItem"("suppressed");
