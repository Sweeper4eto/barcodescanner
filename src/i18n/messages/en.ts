export const en = {
  ...
  buyList: {
    title: "Buy list",
    remove: "Remove",
    empty: "Nothing on your buy list yet.",
    searchPlaceholder: "Search by name or barcode",
    clearSearch: "Clear",
    noResults: "No matching items on your buy list.",
    searching: "Searching...",
    loading: "Loading...",
    unavailable: "Buy list is not available for your account.",
    confirmTitle: "Confirm removal",
    confirmMessage: "Remove this item from the buy list?",
    confirmCancel: "Cancel",
    enteredOn: "Added on:",
    pieces: "Qty",
    viewEntry: "View item details",
  ...
  scanner: {
    ...
    tips: "Point the camera at the barcode and hold steady.",
    refocus: "Refocus",
