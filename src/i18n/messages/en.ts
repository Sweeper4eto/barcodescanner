export const en = {
  ...
  buyList: {
    ...
    searchPlaceholder: "Search by name or barcode",
    clearSearch: "Clear",
    noResults: "No matching items in the list.",
    searching: "Searching...",
    loading: "Loading...",
    unavailable: "The list is not available for your account.",
    confirmTitle: "Confirm removal",
    confirmMessage: "Remove this item from the list?",
    confirmCancel: "Cancel",
    enteredOn: "Added on:",
    pieces: "pcs",
    viewEntry: "View item details",
    ...
    moveToExpiryMessage: "Choose an expiry date, then confirm to move this item from the list.",
    moveToExpiryConfirm: "Move",
    movedToExpiry: "Moved to expiry",
    moveToExpiryFailed: "Could not move to expiry",
    addedFromFavourite: "Added to list",
    addFailed: "Could not add to list",
    adding: "Adding...",
    scanAdded: "Scanned item added to list",
    ...
    addFavouriteToOrders: "Add to list",
    addManual: "Add note",
    addManualTitle: "Add to list",
