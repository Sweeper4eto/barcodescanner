export const en = {
  ...
  errors: {
    ...
    homeUserRequired: "This feature is only available for home users",
  ...
  addDocument: {
    ...
    warnNoProductMatch: "No product match",
    warnExpiryPast: "Expiry is in the past",
    warnExpiryFarFuture: "Expiry looks far in the future",
    warnQuantityHigh: "Quantity looks high",
    retrying: "Reading document… retrying",
    removeRow: "Remove row",
    removeConfirmMessage: "Remove this row from the import list?",
    editItem: "Edit item",
    searchPlaceholder: "Search by name, barcode or articul",
    noResults: "No matching items",
    emptyReview: "No items left. Retake the photo to try again.",
    confirmImport: "Add to expiry",
    importing: "Adding...",
  ...
  expiry: {
    ...
    moveToOrdersTitle: "Add to orders",
    moveToOrdersMessage: "Choose how many to add. The item stays in expiry.",
    moveToOrdersConfirm: "Add",
    addedToOrders: "Added to orders",
    addToOrdersFailed: "Could not add to orders",
  ...
  buyList: {
    title: "Orders",
    remove: "Remove",
    empty: "Nothing on your orders list yet.",
    searchPlaceholder: "Search by name or barcode",
    clearSearch: "Clear",
    noResults: "No matching items in orders.",
    searching: "Searching...",
    loading: "Loading...",
    unavailable: "Orders are not available for your account.",
    confirmTitle: "Confirm removal",
    confirmMessage: "Remove this item from orders?",
    confirmCancel: "Cancel",
    enteredOn: "Added on:",
    pieces: "Qty",
    viewEntry: "View item details",
    ...
    moveToExpiryMessage: "Choose an expiry date, then confirm to move this item from orders.",
    moveToExpiryConfirm: "Move",
    movedToExpiry: "Moved to expiry",
    moveToExpiryFailed: "Could not move to expiry",
    addedFromFavourite: "Added to orders",
    addFailed: "Could not add to orders",
    adding: "Adding...",
    scanAdded: "Scanned item added to orders",
    ...
    addFavouriteToOrders: "Add to orders",
    addManual: "Add note",
    addManualTitle: "Add to orders",
  ...
  camera: {
    ...
    capture: "Take photo",
    newPhoto: "New photo",
    uploadExisting: "Upload existing photo",
  ...
  admin: {
    ...
    homeUser: "Home user",
    homeUserHint: "Users assigned to this client inherit this flag.",
    ...
    auditEvents: {
      ...
      buy_list_added: "Buy list item added",
      buy_list_merged: "Buy list item merged",
      buy_list_removed: "Buy list item removed",
      buy_list_updated: "Buy list item updated",
    },
    editItem: "Edit item",
