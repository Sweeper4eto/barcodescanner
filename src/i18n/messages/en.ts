export const en = {
  ...
  app: {
    ...
    contactHint: "Report issues or ask for help",
  },
  support: {
    ...
    contactPlaceholder: "you@email.com or +359…",
  ...
  push: {
    title: "Expiry alerts",
    description:
      "Get notified when products in your locations are close to expiring. Requires the app to be installed on your home screen (iOS) or allowed notifications in the browser.",
